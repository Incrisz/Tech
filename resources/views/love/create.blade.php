...
@section('title', 'Register Love-Seed')
                        ...
                        <div class="card border-top border-0 border-4 border-danger">
							<div class="card-body p-5">
								<div class="card-title d-flex align-items-center">
									...
									<h5 class="mb-0 text-danger">Add Love Seed</h5>
								</div>
								<hr>
								<form class="row g-3" action="{{ route('love.store')}}" method="POST" enctype="multipart/form-data">
								@method('POST')
								@csrf
									<div class="col-md-8">
										<label for="inputLastName1" class="form-label">Amount</label>
										<div class="input-group"> <span class="input-group-text bg-transparent"><i class='bx bxs-user'></i></span>
											<input type="number" class="form-control border-start-0" id="inputLastName1" name="amount" value="" placeholder="2000" required/>
										</div>
									</div>
